...
-- O GESTOR DE MARKETING PEDIU A LISTA DAS FUNCIONARIS QUE TRABALHEM NO DEPARTAMENTO
-- DE FILMES OU NO DEPARTAMENTO DE LAR. ELE NECESSITAR ENVIAR UM EMAIL PARA AS COLABORADORAS
-- DESSES DOIS SETORES
